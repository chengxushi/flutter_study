...
class CustomFijkSlider extends StatefulWidget {
  final double value;
  ...
  final CustomFijkSliderColors colors;

  const CustomFijkSlider({
    Key key,
    @required this.value,
    ...
    this.min = 0.0,
    this.max = 1.0,
    this.colors = const CustomFijkSliderColors(),
  })  : assert(value != null),
  ...
  @override
  _CustomFijkSliderState createState() => _CustomFijkSliderState();
}

class _CustomFijkSliderState extends State<CustomFijkSlider> {
  bool dragging = false;
...
//        print('============onHorizontalDragUpdate===${details.localPosition.dx}');
...
class CustomFijkSliderColors {
  const CustomFijkSliderColors({
    this.playedColor = const Color.fromRGBO(255, 0, 0, 0.6),
    this.bufferedColor = const Color.fromRGBO(50, 50, 100, 0.1),
  ...
  bool operator ==(Object other) =>
      ...
      other is CustomFijkSliderColors &&
